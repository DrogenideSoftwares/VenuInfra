...
<nav class="navbar navbar-inverse">
  ...
  <div class="row content">
    ...
    <p><span class="glyphicon glyphicon-user"></span style="text-decoration: none; color: black; text-transform: uppercase;">${username}</p><br>      
      <a href="Registration3.jsp"><button class="btn btn-danger navbar-btn">Create store</button></a>
      <p><a href="#">Link</a></p>
      <p><a href="#">Link</a></p>
    </div>
      
      <div class="row">
  <a href="StoremanagerServlet"><div class="col-sm-2">
          <div class="well">
            <h4>Store Manager</h4>
            <p>No. of Delivery Boy</p> 
          </div>
        </div></a>
        <div class="col-sm-2">
          <div class="well">
